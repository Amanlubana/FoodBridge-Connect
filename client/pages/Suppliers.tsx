  ...
  const benefits = [
    {
      ...
      description: 'Connect with thousands of food vendors across multiple cities'
    },
    {
    ...
    },
    {
      ...
      description: 'Track performance, demand patterns, and growth opportunities'
    },
    {
      icon: <MapPin className="w-6 h-6" />,
      title: 'Route Optimization',
      description: 'AI-powered delivery routing to maximize efficiency and reduce costs'
    },
    {
      icon: <Globe className="w-6 h-6" />,
      title: 'Market Expansion',
      description: 'Reach new markets and customer segments beyond your current network'
    }
  ];
  ...
  const steps = [
    {
      ...
      description: 'Create your supplier profile and complete our quick verification process'
    },
    {
      step: '02',
      title: 'List Products',
      description: 'Add your products with pricing, availability, and delivery areas'
    },
    {
      step: '03',
      title: 'Receive Orders',
      description: 'Get notified of new orders and manage them through our dashboard'
    },
    {
      step: '04',
      title: 'Deliver & Grow',
      description: 'Fulfill orders, collect payments, and build your vendor network'
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment: 'Increased my monthly revenue by 40% within 3 months. The platform makes it so easy to manage multiple vendors.'
    },
    {
      name: 'Meera Singh',
      business: 'Punjab Vegetables',
      rating: 5,
      comment: 'No more chasing payments! FreshLink ensures I get paid on time, every time. Game changer for my business.'
    },
    {
      name: 'Rahman Wholesale',
      business: 'Chennai Mandi',
      rating: 5,
      comment: 'The route optimization saved me 25% on delivery costs. Now I can serve vendors across the entire city efficiently.'
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Connect directly with food vendors, eliminate middlemen, and build predictable revenue streams. 
              Whether you're a farmer, wholesaler, or mandi dealer - expand your reach with FreshLink.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Everything you need to scale your supply business and increase profitability
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Our suppliers typically see significant revenue growth within the first 3 months. 
                  Direct vendor relationships mean better margins and more predictable income.
                </p>
              </div>
            ...
            <Card className="border-0 shadow-2xl">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-2xl">Supplier Success Story</CardTitle>
                <CardDescription>
              ...
              <CardContent className="space-y-4">
                <div className="bg-muted/50 p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Badge className="bg-success text-success-foreground">+55%</Badge>
                  </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <p className="text-xl opacity-90 leading-relaxed">
              Join the largest network of food suppliers in India. Start connecting with thousands 
              of food vendors and grow your revenue with predictable, reliable orders.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              ...
              <Button size="lg" variant="outline" className="text-lg px-8 py-6 border-accent-foreground text-accent-foreground hover:bg-accent-foreground hover:text-accent" asChild>
                <Link to="/login">
                  Sign In
                </Link>
              </Button>
